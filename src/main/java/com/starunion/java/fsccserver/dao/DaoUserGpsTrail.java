...
public class DaoUserGpsTrail extends DbUtilsTemplate {
	...
	public int addExtenGpsTrail(String number,String lng,String lat,String type) {
		StringBuffer sql = new StringBuffer();
		sql.append("insert into dis_exten_gistrail (exten,lng,lat,type) values (");
	...
	public int batchInsertGps(String number){
		...
		for(int i=0;i<200;i++){
			...
			addExtenGpsTrail(number,s1,s2,"1");
			d1-=0.01;
			d2+=0.01;
		}
